...
```
(Comments aren't supported in JSON, remove them beforehand.)
*Everything `advanced` is optional, and not including them will make them use their default values (which are shown above).*
